function [TabA,lia,TinAnotB,TinBnotA] = queryTabAinTabBQuiet(TabA,TabB,keyA,keyB,valsA,valsB,varargin)
% SYNTAX: 
% [TabA,lia,TinAnotB,TinBnotA] = queryTabAinTabB(TabA,TabB,keyA,keyB,valsA,valsB,varargin)
...
[valueSQueried, lia, TinAnotB,TinBnotA]= queryQuiet(keyAdata,TabB,keyB,valsB);
