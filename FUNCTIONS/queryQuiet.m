function [value, lia, TinAnotB,TinBnotA] = queryQuiet(key,Table,keyVariableInTable,ValueVariableInTable,varargin)
...
if ncol>1
    ...
    for icol = 1:ncol
        ...
        switch class(ValueSetInTable)
            ...
            case {'cell'}
                ...
                if iscellstr(ValueSetInTable)
                    value{icol} = repmat({''},nkey,1);
                end
            case {'double'}
    ...
    value = missingData(ValueSetInTable,nkey,1);
