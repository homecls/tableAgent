function obj = gen_dummy (obj, tableVariable)
% TB.gen_dummy('Year') % linrenwen@gmail.com
    %
    ...
    T = obj.table; % added by linrnewen@gmail.com
    if ~istable(T)
    ...
    if numCategories<100 % maximum of 99 categories for the variable splitting to be created
        ...
        % T=removevars(T,tableVariable);    % delete by linrnewen@gmail.com
    ...
    obj.table = T; % added by linrnewen@gmail.com
end % end of function
